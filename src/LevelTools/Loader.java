...
public class Loader extends JavaPlugin {
	String prefix = "&aLevel&fTools";
	public static Loader instance;
	public static FileConfiguration config;
	public static FileConfiguration Translation;
	
	public void onLoad() {
		TheAPI.getConsole().sendMessage(TheAPI.colorize(prefix+"&7 *********************************************"));
		TheAPI.getConsole().sendMessage(TheAPI.colorize(prefix+"&a Plugin has been &fLoaded &a."));
		TheAPI.getConsole().sendMessage(TheAPI.colorize(prefix+"&7 *********************************************"));
		Configs.LoadConfigs();
	}
	public void onEnable() {	
        ...
        TheAPI.getConsole().sendMessage(TheAPI.colorize(prefix+"&7 *********************************************"));
		TheAPI.getConsole().sendMessage(TheAPI.colorize(prefix+"&a Loadin configs, loading commands ...."));
		TheAPI.getConsole().sendMessage(TheAPI.colorize(prefix+"&7 *********************************************"));
    }
